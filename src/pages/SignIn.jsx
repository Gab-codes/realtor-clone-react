        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form>
            <input className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out'
             type='email' placeholder='Email address' id='email' value={email} onChange={onChange}></input>
            <div className='relative mb-6'>
            <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out'
             type={showPassword ? "text" : "password"} placeholder='Password' id='password' value={password} onChange={onChange}></input>

             {/* the initial show password is false, so it will display the AiFillEye icon and hide the password initially*/}
            { showPassword ? (
            ...
            <div className="mb-6 flex justify-between whitespace-nowrap text-sm sm:text-lg">
              <p> 
                Don't have a account?<Link to="/sign-up" className="text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1">Register</Link> 
              </p>
              <p>
